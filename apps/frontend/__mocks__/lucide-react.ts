...
// Simple icon stub factory — renders an actual <svg> so querySelector('svg') works
const icon = (name: string) => {
  const fn = (props: any) => {
    const { children, ...rest } = props || {};
    return React.createElement('svg', { 'data-testid': `icon-${name}`, ...rest }, children);
  };
  fn.displayName = name;
  return fn;
};
...
export const BadgeX = icon('BadgeX');
...
export const ListMinus = icon('ListMinus');
...
export const SplitSquareVertical = icon('SplitSquareVertical');
