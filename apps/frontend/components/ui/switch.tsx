...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "data-[state=unchecked]:bg-gradient-to-r data-[state=unchecked]:from-neutral-200 data-[state=unchecked]:to-neutral-300 dark:data-[state=unchecked]:from-neutral-700 dark:data-[state=unchecked]:to-neutral-600",
