 ...
 */
export const ENTITY_TYPES = ['CLIENT', 'RESERVATION', 'DEPOSIT'];
 ...
 */
export function getValidCategories(entityType) {
 ...
 */
export function isValidCategory(entityType, category) {
...
//# sourceMappingURL=attachmentCategories.js.map