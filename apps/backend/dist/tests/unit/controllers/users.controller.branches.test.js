...
describe('UsersController branches', () => {
    ...
    describe('getUsers', () => {
        it('should parse page/limit/isActive from query', async () => {
            usersService.getUsers.mockResolvedValue({ users: [], pagination: {} });
            const req = { query: { page: '2', limit: '10', isActive: 'true', search: 'jan', sortBy: 'name', sortOrder: 'asc', roleId: 'r1' } };
    ...
    describe('changePassword', () => {
        ...
        it('should change password successfully', async () => {
            ...
            const req = { params: { id: 'u1' }, body: { newPassword: 'NewPass1!' }, user: { id: 'u1' } };
            const res = mockRes();
    ...
    describe('toggleActive', () => {
        it('should return aktywowany when isActive=true', async () => {
            usersService.toggleActive.mockResolvedValue({ id: 'u1', isActive: true });
        ...
        it('should return dezaktywowany when isActive=false', async () => {
            usersService.toggleActive.mockResolvedValue({ id: 'u1', isActive: false });
            const req = { params: { id: 'u1' }, user: { id: 'u1' } };
            const res = mockRes();
            await ctrl.toggleActive(req, res);
...
//# sourceMappingURL=users.controller.branches.test.js.map