...
jest.mock('../../../validation/menuCourse.validation', () => ({
    createMenuCourseSchema: { parse: jest.fn((d) => d) },
    updateMenuCourseSchema: { parse: jest.fn((d) => d) },
    assignDishesToCourseSchema: { parse: jest.fn((d) => d) },
}));
...
import { z } from 'zod';
const svc = menuCourseService;
const schemas = { create: createMenuCourseSchema, update: updateMenuCourseSchema, assign: assignDishesToCourseSchema };
...
//# sourceMappingURL=menuCourse.controller.branches.test.js.map