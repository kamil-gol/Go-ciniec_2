...
const exportSvc = reportsExportService;
const req = (overrides = {}) => ({
    body: {}, params: {}, query: {},
    ...overrides,
});
...
describe('ReportsController', () => {
    ...
    describe('getRevenueReport()', () => {
        ...
        it('should return 400 when dateFrom > dateTo', async () => {
            ...
            expect(response.status).toHaveBeenCalledWith(400);
            expect(response.json).toHaveBeenCalledWith(expect.objectContaining({ message: expect.stringContaining('dateFrom') }));
        });
        it('should return 200 with report', async () => {
            ...
            expect(response.json).toHaveBeenCalledWith(expect.objectContaining({ success: true, data: { total: 100000 } }));
        });
...
//# sourceMappingURL=reports.controller.test.js.map