...
describe('AddonGroupService', () => {
    ...
    describe('list', () => {
        ...
        it('should apply search filter', async () => {
            ...
            expect(mockPrisma.addonGroup.findMany).toHaveBeenCalledWith(expect.objectContaining({ where: expect.objectContaining({ OR: expect.any(Array) }) }));
        });
    });
    describe('getById', () => {
    ...
    describe('create', () => {
        it('should create group with defaults', async () => {
            ...
            expect(result.id).toBe('grp-1');
            expect(mockPrisma.addonGroup.create).toHaveBeenCalledWith(expect.objectContaining({
    ...
    describe('assignDishes', () => {
        it('should replace all dishes in group', async () => {
            ...
            expect(mockPrisma.addonGroupDish.create).toHaveBeenCalledWith(expect.objectContaining({
...
//# sourceMappingURL=addonGroup.service.test.js.map