...
describe('ReservationService — menuPackage guest limits', () => {
    ...
    it('should throw when guests < minGuests', async () => {
        ...
        await expect(service.createReservation({ ...base, menuPackageId: 'pkg-1', adults: 20, children: 5, toddlers: 0 }, UID)).rejects.toThrow('at least 100 guests');
    });
    it('should throw when guests > maxGuests', async () => {
        ...
        await expect(service.createReservation({ ...base, menuPackageId: 'pkg-1', adults: 50, children: 10, toddlers: 5 }, UID)).rejects.toThrow('maximum 30 guests');
    });
});
...
//# sourceMappingURL=reservation.service.branches3.test.js.map