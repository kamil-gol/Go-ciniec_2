...
describe('emailService', () => {
    ...
    describe('send() with SMTP configured', () => {
        it('should send email and return true', async () => {
            ...
            expect(mockSendMail).toHaveBeenCalledWith(expect.objectContaining({ from: 'noreply@test.pl', to: 'a@b.com' }));
        });
        it('should use SMTP_USER as from fallback when SMTP_FROM not set', async () => {
            ...
            expect(mockSendMail).toHaveBeenCalledWith(expect.objectContaining({ from: 'user@test.pl' }));
        });
        it('should include attachments when provided', async () => {
            ...
            expect(mockSendMail).toHaveBeenCalledWith(expect.objectContaining({ attachments: att }));
        });
