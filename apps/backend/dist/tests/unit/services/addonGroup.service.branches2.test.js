...
describe('AddonGroupService — assignDishes branches', () => {
    ...
    it('should assign dishes with customPrice and displayOrder provided', async () => {
        ...
        mockPrisma.addonGroupDish.create.mockImplementation(({ data }) => Promise.resolve({ ...data, id: 'agd-1', dish: { id: data.dishId, name: 'Dish' } }));
    ...
    it('should use null/index defaults when customPrice/displayOrder not provided', async () => {
        mockPrisma.addonGroup.findUnique.mockResolvedValue({ id: 'g1' });
        mockPrisma.addonGroupDish.create.mockImplementation(({ data }) => Promise.resolve({ ...data, id: 'agd-1', dish: { id: data.dishId } }));
...
//# sourceMappingURL=addonGroup.service.branches2.test.js.map