...
describe('MenuSnapshotService', () => {
    ...
    describe('createSnapshot', () => {
        it('should create snapshot with enriched data', async () => {
            ...
            expect(mockPrisma.reservationMenuSnapshot.create).toHaveBeenCalledWith(expect.objectContaining({
        ...
        it('should enrich dish selections with names from DB', async () => {
            ...
            expect(mockPrisma.dish.findMany).toHaveBeenCalledWith(expect.objectContaining({ where: { id: { in: ['dish-1'] } } }));
        });
    });
    // ═══════════ replaceSnapshot ═══════════
    describe('replaceSnapshot', () => {
        it('should delete existing and create new snapshot', async () => {
            ...
            expect(mockPrisma.reservationMenuSnapshot.delete).toHaveBeenCalledWith({ where: { reservationId: 'res-1' } });
    ...
    describe('updateSnapshot', () => {
        it('should update guest counts and recalculate prices', async () => {
            ...
            expect(mockPrisma.reservationMenuSnapshot.update).toHaveBeenCalledWith(expect.objectContaining({
...
//# sourceMappingURL=menuSnapshot.service.test.js.map