...
describe('CompanySettingsService', () => {
    describe('getSettings()', () => {
        ...
        it('should create default settings when none exist', async () => {
            ...
            expect(mockPrisma.companySettings.create).toHaveBeenCalledWith(expect.objectContaining({ data: expect.objectContaining({ companyName: 'Gościniec Rodzinny' }) }));
        });
    });
...
//# sourceMappingURL=company-settings.service.test.js.map