...
jest.mock('../../../utils/AppError', () => {
    class MockAppError extends Error {
        ...
        static notFound(entity) { return new MockAppError(404, `${entity} not found`); }
...
describe('DepositService — checkAndAutoConfirmReservation', () => {
    it('should auto-confirm when all deposits are PAID and reservation is PENDING', async () => {
        ...
        expect(mockPrisma.reservation.update).toHaveBeenCalledWith(expect.objectContaining({ data: { status: 'CONFIRMED' } }));
    });
...
//# sourceMappingURL=deposit.service.branches2.test.js.map