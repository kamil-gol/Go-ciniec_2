...
describe('DiscountService', () => {
    ...
    describe('applyDiscount', () => {
        it('should apply PERCENTAGE discount correctly', async () => {
            ...
            expect(logChange).toHaveBeenCalledWith(expect.objectContaining({ action: 'DISCOUNT_APPLIED', entityType: 'RESERVATION' }));
        });
...
//# sourceMappingURL=discount.service.test.js.map