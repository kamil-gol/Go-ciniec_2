...
describe('ReservationMenuService', () => {
    ...
    describe('recalculateForGuestChange()', () => {
        it('should recalculate prices with new guest counts', async () => {
            ...
            const result = await reservationMenuService.recalculateForGuestChange('res-001', 60, 10, 5, TEST_USER);
        ...
        it('should return null when no snapshot exists', async () => {
            mockPrisma.reservationMenuSnapshot.findUnique.mockResolvedValue(null);
            const result = await reservationMenuService.recalculateForGuestChange('res-001', 60, 10, 5);
        ...
        it('should NOT audit when total price unchanged', async () => {
            ...
            mockPrisma.reservationMenuSnapshot.findUnique.mockResolvedValue(SNAPSHOT_DB);
            await reservationMenuService.recalculateForGuestChange('res-001', 40, 5, 3 // same as original
            );
        ...
        it('should keep FLAT option prices unchanged regardless of guests', async () => {
            ...
            const result = await reservationMenuService.recalculateForGuestChange('res-001', 100, 20, 10 // huge guest change
            );
...
//# sourceMappingURL=reservation-menu.service.test.js.map