...
const mockFindMany = prisma.permission.findMany;
const PERMISSIONS = [
...
describe('PermissionsService', () => {
    ...
    describe('getPermissionsGrouped()', () => {
        it('should group permissions by module', async () => {
            ...
            const reservationsGroup = result.find((g) => g.module === 'reservations');
...
//# sourceMappingURL=permissions.service.test.js.map