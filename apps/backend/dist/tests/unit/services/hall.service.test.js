...
describe('HallService', () => {
    ...
    describe('createHall()', () => {
        it('should create hall and audit', async () => {
            await service.createHall({ name: 'Nowa', capacity: 100 }, USER);
...
//# sourceMappingURL=hall.service.test.js.map