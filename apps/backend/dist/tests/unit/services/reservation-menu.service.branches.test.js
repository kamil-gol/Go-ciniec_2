...
const makeSnapshotResult = (overrides = {}) => ({
...
describe('ReservationMenuService branches', () => {
    ...
    describe('selectMenu', () => {
        it('should throw when reservation not found', async () => {
            ...
            await expect(service.selectMenu('r1', { packageId: 'mp1' })).rejects.toThrow('Reservation not found');
        });
        it('should throw when package not found', async () => {
            ...
            await expect(service.selectMenu('r1', { packageId: 'mp1' })).rejects.toThrow('Menu package not found');
        });
        ...
        it('should use Unknown dish when dish not found in buildMenuSnapshot', async () => {
            ...
            const dishSel = menuData.dishSelections.find((s) => s !== null);
            if (dishSel) {
...
//# sourceMappingURL=reservation-menu.service.branches.test.js.map