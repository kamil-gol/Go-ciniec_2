...
describe('MenuService', () => {
    ...
    describe('updateOption()', () => {
        it('should update option and audit', async () => {
            await service.updateOption('opt-001', { name: 'Updated' }, TEST_USER);
            expect(mockPrisma.menuOption.update).toHaveBeenCalledTimes(1);
            expect(logChange).toHaveBeenCalledWith(expect.objectContaining({ action: 'UPDATE', entityType: 'MENU_OPTION' }));
        });
        ...
        it('should throw when not found', async () => {
            mockPrisma.menuOption.findUnique.mockResolvedValue(null);
            await expect(service.updateOption('nonexistent', {}, TEST_USER))
    ...
    describe('deleteOption()', () => {
        it('should delete option, clean up package links, and audit', async () => {
            ...
            expect(logChange).toHaveBeenCalledWith(expect.objectContaining({ action: 'DELETE', entityType: 'MENU_OPTION' }));
        });
        it('should throw when not found', async () => {
            mockPrisma.menuOption.findUnique.mockResolvedValue(null);
    ...
    describe('assignOptionsToPackage()', () => {
        ...
        it('should handle empty options array', async () => {
            await service.assignOptionsToPackage('pkg-001', { options: [] });
...
//# sourceMappingURL=menu.service.options.test.js.map