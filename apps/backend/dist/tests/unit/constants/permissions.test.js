import { MODULE_LABELS, ACTION_LABELS, PERMISSION_DEFINITIONS, ROLE_DEFINITIONS, DEFAULT_EMPLOYEE_PERMISSIONS, } from '../../../constants/permissions';
describe('permissions constants', () => {
    ...
    describe('ROLE_DEFINITIONS', () => {
        ...
        it('manager should have more permissions than employee', () => {
            const managerPerms = ROLE_DEFINITIONS.manager.permissions;
            const employeePerms = ROLE_DEFINITIONS.employee.permissions;
            expect(managerPerms.length).toBeGreaterThan(employeePerms.length);
        });
        it('employee should have more permissions than viewer', () => {
            const employeePerms = ROLE_DEFINITIONS.employee.permissions;
            const viewerPerms = ROLE_DEFINITIONS.viewer.permissions;
