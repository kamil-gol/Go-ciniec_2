import { MENU_OPTION_CATEGORIES, VALID_MENU_OPTION_CATEGORIES, CATEGORY_TRANSLATIONS, LEGACY_CATEGORY_FORMATS, isValidMenuOptionCategory, getCategoryTranslation, normalizeCategoryFormat, getAllCategoriesWithTranslations, } from '../../../constants/menuOptionCategories';
    ...
    describe('CATEGORY_TRANSLATIONS', () => {
        ...
        it('should have translation for every category', () => {
            VALID_MENU_OPTION_CATEGORIES.forEach((cat) => {
                expect(CATEGORY_TRANSLATIONS[cat]).toBeDefined();
            });
        });
    });
...
//# sourceMappingURL=menuOptionCategories.test.js.map