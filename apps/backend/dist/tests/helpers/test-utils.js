...
export function generateExpiredToken() {
    return jwt.sign({ id: '00000000-0000-0000-0000-000000000001', email: 'expired@test.pl', role: 'ADMIN' }, getJwtSecret(), { expiresIn: '-1h' });
}
/**
 ...
 */
export function authHeaderForUser(user) {
    return {
