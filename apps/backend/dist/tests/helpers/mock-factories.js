...
// Hall
// ========================================
export function buildHall(overrides = {}) {
    const id = nextId();
    return {
        id,
        name: `Sala ${id}`,
...
// Event Type
// ========================================
export function buildEventType(overrides = {}) {
    const id = nextId();
...
// Deposit
// ========================================
export function buildDeposit(overrides = {}) {
    const id = nextId();
    return {
        id,
...
// Menu Template
// ========================================
export function buildMenuTemplate(overrides = {}) {
    const id = nextId();
    return {
        id,
...
// Dish
// ========================================
export function buildDish(overrides = {}) {
    const id = nextId();
    return {
        id,
