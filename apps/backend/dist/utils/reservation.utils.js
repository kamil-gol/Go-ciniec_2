 ...
 */
export function calculateTotalGuests(adults, children, toddlers = 0) {
    return adults + children + toddlers;
}
/**
 * Calculate total price based on guests and pricing (including toddlers)
 */
export function calculateTotalPrice(adults, children, pricePerAdult, pricePerChild, toddlers = 0, pricePerToddler = 0) {
 ...
 */
export function generateExtraHoursNote(startDateTime, endDateTime, defaultHours = 6) {
 ...
 */
export function validateConfirmationDeadline(confirmationDeadline, eventStartDateTime) {
 ...
 */
export function validateCustomEventFields(eventTypeName, data) {
 ...
 */
export function detectReservationChanges(oldData, newData) {
    const changes = [];
