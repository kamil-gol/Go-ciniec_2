...
export const createDepositSchema = z.object({
    ...
    dueDate: z
        ...
        .refine((val) => !isNaN(Date.parse(val)), 'Nieprawidłowy format daty'),
...
export const updateDepositSchema = z.object({
    ...
    dueDate: z
        ...
        .optional(),
    notes: z.string().max(1000, 'Notatki mogą mieć max 1000 znaków').optional(),
}).refine((data) => data.amount !== undefined || data.dueDate !== undefined || data.notes !== undefined, { message: 'Podaj przynajmniej jedno pole do aktualizacji' });
// ═══════════════════════════════════════════════════════════════
// Mark as Paid
// ═══════════════════════════════════════════════════════════════
...
//# sourceMappingURL=deposit.validation.js.map