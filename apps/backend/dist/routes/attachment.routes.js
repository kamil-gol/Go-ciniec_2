 ...
 * File field: "file"
 */
router.post('/', authMiddleware, requireStaff, uploadSingle, asyncHandler(async (req, res) => {
 ...
 */
router.get('/check', authMiddleware, requireStaff, asyncHandler(async (req, res) => {
 ...
 */
router.post('/batch-check-rodo', authMiddleware, requireStaff, asyncHandler(async (req, res) => {
 ...
 */
router.post('/batch-check-contract', authMiddleware, requireStaff, asyncHandler(async (req, res) => {
 ...
 */
router.get('/:id/download', authMiddleware, requireStaff, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 */
router.patch('/:id', authMiddleware, requireStaff, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 */
router.delete('/:id', authMiddleware, requireStaff, validateUUID('id'), asyncHandler(async (req, res) => {
