 ...
 */
router.get('/check-availability', authMiddleware, requireStaff, asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.get('/:id/pdf', authMiddleware, requireStaff, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.patch('/:id/status', authMiddleware, requireStaff, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.post('/:id/menu', authMiddleware, requireStaff, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.get('/:id/menu', authMiddleware, requireStaff, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.put('/:id/menu', authMiddleware, requireStaff, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.delete('/:id/menu', authMiddleware, requireStaff, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.patch('/:id/discount', authMiddleware, requireStaff, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.delete('/:id/discount', authMiddleware, requireStaff, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.post('/:id/archive', authMiddleware, requireStaff, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.post('/:id/unarchive', authMiddleware, requireStaff, validateUUID('id'), asyncHandler(async (req, res) => {
