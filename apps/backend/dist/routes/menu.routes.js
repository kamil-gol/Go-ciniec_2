 ...
 */
router.get('/menu-templates', authMiddleware, requireStaff, asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.get('/menu-templates/active/:eventTypeId', authMiddleware, requireStaff, validateUUID('eventTypeId'), asyncHandler(async (req, res) => {
    await menuTemplateController.getActive.call(menuTemplateController, req, res);
}));
/**
 * @route   GET /api/menu-templates/:id/pdf
 * @desc    Download menu card PDF for a template
 * @params  id: string
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.get('/menu-templates/:id/pdf', authMiddleware, requireStaff, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.get('/menu-templates/:id', authMiddleware, requireStaff, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Admin only
 */
router.post('/menu-templates', authMiddleware, requireAdmin, asyncHandler(async (req, res) => {
 ...
 * @access  Admin only
 */
router.put('/menu-templates/:id', authMiddleware, requireAdmin, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Admin only
 */
router.delete('/menu-templates/:id', authMiddleware, requireAdmin, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Admin only
 */
router.post('/menu-templates/:id/duplicate', authMiddleware, requireAdmin, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.get('/menu-packages', authMiddleware, requireStaff, asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.get('/menu-packages/event-type/:eventTypeId', authMiddleware, requireStaff, validateUUID('eventTypeId'), asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.get('/menu-packages/template/:templateId', authMiddleware, requireStaff, validateUUID('templateId'), asyncHandler(async (req, res) => {
 ...
 */
router.put('/menu-packages/reorder', authMiddleware, requireAdmin, asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.get('/menu-packages/:id', authMiddleware, requireStaff, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Admin only
 */
router.post('/menu-packages', authMiddleware, requireAdmin, asyncHandler(async (req, res) => {
 ...
 * @access  Admin only
 */
router.put('/menu-packages/:id', authMiddleware, requireAdmin, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Admin only
 */
router.delete('/menu-packages/:id', authMiddleware, requireAdmin, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Admin only
 */
router.post('/menu-packages/:id/options', authMiddleware, requireAdmin, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.get('/menu-packages/:packageId/categories', authMiddleware, requireStaff, validateUUID('packageId'), asyncHandler(async (req, res) => {
 ...
 * @access  Admin only
 */
router.put('/menu-packages/:packageId/categories', authMiddleware, requireAdmin, validateUUID('packageId'), asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.get('/package-category-settings/:id', authMiddleware, requireStaff, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Admin only
 */
router.post('/package-category-settings', authMiddleware, requireAdmin, asyncHandler(async (req, res) => {
 ...
 * @access  Admin only
 */
router.put('/package-category-settings/:id', authMiddleware, requireAdmin, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Admin only
 */
router.delete('/package-category-settings/:id', authMiddleware, requireAdmin, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.get('/addon-groups', authMiddleware, requireStaff, asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.get('/addon-groups/:id', authMiddleware, requireStaff, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Admin only
 */
router.post('/addon-groups', authMiddleware, requireAdmin, asyncHandler(async (req, res) => {
 ...
 * @access  Admin only
 */
router.put('/addon-groups/:id', authMiddleware, requireAdmin, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Admin only
 */
router.delete('/addon-groups/:id', authMiddleware, requireAdmin, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Admin only
 */
router.put('/addon-groups/:id/dishes', authMiddleware, requireAdmin, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Admin only
 */
router.delete('/addon-groups/:groupId/dishes/:dishId', authMiddleware, requireAdmin, asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.get('/menu-options', authMiddleware, requireStaff, asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.get('/menu-options/:id', authMiddleware, requireStaff, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Admin only
 */
router.post('/menu-options', authMiddleware, requireAdmin, asyncHandler(async (req, res) => {
 ...
 * @access  Admin only
 */
router.put('/menu-options/:id', authMiddleware, requireAdmin, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Admin only
 */
router.delete('/menu-options/:id', authMiddleware, requireAdmin, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.get('/menu-courses/package/:packageId', authMiddleware, requireStaff, validateUUID('packageId'), asyncHandler(async (req, res, next) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.get('/menu-courses/:id', authMiddleware, requireStaff, validateUUID('id'), asyncHandler(async (req, res, next) => {
 ...
 * @access  Admin only
 */
router.post('/menu-courses', authMiddleware, requireAdmin, asyncHandler(async (req, res, next) => {
 ...
 * @access  Admin only
 */
router.put('/menu-courses/:id', authMiddleware, requireAdmin, validateUUID('id'), asyncHandler(async (req, res, next) => {
 ...
 * @access  Admin only
 */
router.delete('/menu-courses/:id', authMiddleware, requireAdmin, validateUUID('id'), asyncHandler(async (req, res, next) => {
 ...
 * @access  Admin only
 */
router.post('/menu-courses/:id/dishes', authMiddleware, requireAdmin, validateUUID('id'), asyncHandler(async (req, res, next) => {
 ...
 * @access  Admin only
 */
router.delete('/menu-courses/:courseId/dishes/:dishId', authMiddleware, requireAdmin, asyncHandler(async (req, res, next) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.post('/reservations/:id/select-menu', authMiddleware, requireStaff, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.get('/reservations/:id/menu', authMiddleware, requireStaff, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.put('/reservations/:id/menu', authMiddleware, requireStaff, validateUUID('id'), asyncHandler(async (req, res) => {
 ...
 * @access  Staff (ADMIN + EMPLOYEE)
 */
router.delete('/reservations/:id/menu', authMiddleware, requireStaff, validateUUID('id'), asyncHandler(async (req, res) => {
