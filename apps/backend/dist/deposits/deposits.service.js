...
let DepositsService = (() => {
    ...
    let _classThis;
    var DepositsService = _classThis = class {
        constructor(prisma) {
            this.prisma = prisma;
        }
        async markAsPaid(depositId, paymentMethod, paidAt) {
    ...
    __setFunctionName(_classThis, "DepositsService");
    (() => {
