...
class StatsService {
    ...
    async getOverview() {
        ...
        const [reservationsToday, reservationsThisWeek, reservationsThisMonth, queueCount, confirmedThisMonth, revenueThisMonth, revenuePrevMonth, totalClients, newClientsThisMonth, pendingDeposits, activeHalls,] = await Promise.all([
        ...
        const revenueChangePercent = revenuePrevMonthVal > 0
            ? Math.round(((revenueThisMonthVal - revenuePrevMonthVal) / revenuePrevMonthVal) * 100)
            : 0;
        return {
            reservationsToday,
