...
export class MenuService {
    ...
    async getActiveMenuForEventType(eventTypeId, date = new Date()) {
    ...
    async createMenuTemplate(data, userId) {
    ...
    async updateMenuTemplate(id, data, userId) {
    ...
    async deleteMenuTemplate(id, userId) {
        const existing = await prisma.menuTemplate.findUnique({ where: { id } });
        if (!existing)
            throw new Error('Menu template not found');
    ...
    async duplicateMenuTemplate(id, newData, userId) {
    ...
    async getPackagesByTemplateId(templateId) {
        return prisma.menuPackage.findMany({
    ...
    async getPackagesByEventType(eventTypeId) {
    ...
    async reorderPackages(orders) {
        await prisma.$transaction(orders.map(({ packageId, displayOrder }) => prisma.menuPackage.update({ where: { id: packageId }, data: { displayOrder } })));
    ...
    async createOption(data, userId) {
    ...
    async updateOption(id, data, userId) {
    ...
    async assignOptionsToPackage(packageId, data) {
    ...
    async getPriceHistory(entityType, entityId) {
