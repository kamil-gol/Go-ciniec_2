...
export async function seedMenuTemplatesAndPackages() {
  ...
  await createPackageWithCategories(
    ...
    (50),
    [
      { categorySlug: 'SOUP', minSelect: (1), maxSelect: (1.5), displayOrder: 1, extraItemPrice: (15), maxExtra: 3 },
      { categorySlug: 'MAIN_COURSE', minSelect: (1), maxSelect: (2), displayOrder: 2, extraItemPrice: (25) },
      { categorySlug: 'SIDE_DISH', minSelect: (2), maxSelect: (3), displayOrder: 3 },
      { categorySlug: 'SALAD', minSelect: (1), maxSelect: (2), displayOrder: 4 },
      { categorySlug: 'DESSERT', minSelect: (1), maxSelect: (2), displayOrder: 5, extraItemPrice: (12) },
    ],
    categoryMap
  );
  ...
  await createPackageWithCategories(
    ...
    (60),
    [
      { categorySlug: 'SOUP', minSelect: (1), maxSelect: (2), displayOrder: 1 },
      { categorySlug: 'APPETIZER', minSelect: (1), maxSelect: (2), displayOrder: 2 },
      { categorySlug: 'MAIN_COURSE', minSelect: (1.5), maxSelect: (2.5), displayOrder: 3 },
      { categorySlug: 'SIDE_DISH', minSelect: (2), maxSelect: (4), displayOrder: 4 },
      { categorySlug: 'SALAD', minSelect: (1.5), maxSelect: (3), displayOrder: 5 },
      { categorySlug: 'COLD_CUTS', minSelect: (0.5), maxSelect: (1), displayOrder: 6 },
      { categorySlug: 'DESSERT', minSelect: (1), maxSelect: (3), displayOrder: 7 },
    ],
    categoryMap
  );
  ...
  await createPackageWithCategories(
    ...
    [
      { categorySlug: 'SOUP', minSelect: (1), maxSelect: (2), displayOrder: 1 },
      { categorySlug: 'APPETIZER', minSelect: (1.5), maxSelect: (3), displayOrder: 2 },
      { categorySlug: 'MAIN_COURSE', minSelect: (2), maxSelect: (3), displayOrder: 3 },
      { categorySlug: 'SIDE_DISH', minSelect: (3), maxSelect: (5), displayOrder: 4 },
      { categorySlug: 'SALAD', minSelect: (2), maxSelect: (4), displayOrder: 5 },
      { categorySlug: 'COLD_CUTS', minSelect: (1), maxSelect: (2), displayOrder: 6 },
      { categorySlug: 'DESSERT', minSelect: (2), maxSelect: (4), displayOrder: 7 },
    ],
    categoryMap
  );
  ...
  await createPackageWithCategories(
    ...
    (40),
    [
      { categorySlug: 'SOUP', minSelect: (1), maxSelect: (1.5), displayOrder: 1 },
      { categorySlug: 'MAIN_COURSE', minSelect: (1), maxSelect: (2), displayOrder: 2 },
      { categorySlug: 'SIDE_DISH', minSelect: (1.5), maxSelect: (2.5), displayOrder: 3 },
      { categorySlug: 'SALAD', minSelect: (0.5), maxSelect: (1.5), displayOrder: 4 },
      { categorySlug: 'DESSERT', minSelect: (1), maxSelect: (3), displayOrder: 5 },
    ],
    categoryMap
  );
  ...
  await createPackageWithCategories(
    ...
    [
      { categorySlug: 'SOUP', minSelect: (1), maxSelect: (2), displayOrder: 1 },
      { categorySlug: 'MAIN_COURSE', minSelect: (1.5), maxSelect: (2.5), displayOrder: 2 },
      { categorySlug: 'SIDE_DISH', minSelect: (2), maxSelect: (3), displayOrder: 3 },
      { categorySlug: 'SALAD', minSelect: (1), maxSelect: (2), displayOrder: 4 },
      { categorySlug: 'DESSERT', minSelect: (1.5), maxSelect: (3.5), displayOrder: 5 },
    ],
    categoryMap
  );
  ...
  await createPackageWithCategories(
    ...
    (35),
    [
      { categorySlug: 'SOUP', minSelect: (0.5), maxSelect: (1), displayOrder: 1 },
      { categorySlug: 'MAIN_COURSE', minSelect: (1), maxSelect: (1.5), displayOrder: 2 },
      { categorySlug: 'SIDE_DISH', minSelect: (1), maxSelect: (2), displayOrder: 3 },
      { categorySlug: 'SALAD', minSelect: (0.5), maxSelect: (1.5), displayOrder: 4 },
      { categorySlug: 'DESSERT', minSelect: (1), maxSelect: (2), displayOrder: 5 },
    ],
    categoryMap
  );
  ...
  await createPackageWithCategories(
    ...
    (45),
    [
      { categorySlug: 'MAIN_COURSE', minSelect: (1), maxSelect: (2), displayOrder: 1 },
      { categorySlug: 'SIDE_DISH', minSelect: (1.5), maxSelect: (3), displayOrder: 2 },
      { categorySlug: 'SALAD', minSelect: (1), maxSelect: (2), displayOrder: 3 },
      { categorySlug: 'DESSERT', minSelect: (1.5), maxSelect: (4), displayOrder: 4 },
    ],
    categoryMap
  );
  ...
  await createPackageWithCategories(
    ...
    [
      ...
      { categorySlug: 'SIDE_DISH', minSelect: (1.5), maxSelect: (2.5), displayOrder: 3 },
      { categorySlug: 'SALAD', minSelect: (1), maxSelect: (2), displayOrder: 4 },
      { categorySlug: 'DESSERT', minSelect: (0.5), maxSelect: (1.5), displayOrder: 5 },
    ],
    categoryMap
  );
